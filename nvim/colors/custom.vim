...
hi Directory term=bold ctermfg=3 guifg=#5fff87
...
hi CursorLineNr term=bold cterm=bold ctermfg=1 gui=bold guifg=Brown
...
hi WarningMsg term=standout cterm=bold ctermfg=1 ctermbg=16 guifg=Red
